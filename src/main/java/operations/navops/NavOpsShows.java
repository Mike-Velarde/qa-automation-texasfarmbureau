...
public abstract class NavOpsShows implements AutomationOperationsListener {
    ...
    public void scrollToBottom() {
       MobileElement  episodeClipsContainer = (MobileElement) driverWrapper.getElementById("awe_showdetail_topcontainer");
...
/*        MobileElement episodeClipsContainer = (MobileElement) driverWrapper.getElementById(ResourceLocator.device.AWE_SHOWS_EPISODES_CLIPS_MAIN_CONTAINER);
    ...
    public void scrollHalfToTop(){
        MobileElement episodeClipsContainer = (MobileElement) driverWrapper.getElementById("awe_foregroundoverlay_container");
        episodeClipsContainer.swipe(SwipeElementDirection.UP,1,0, 5000);
    ...
    /*
     * After clicking the More option, returns the content is availablity status
     */
    ...
    */
    ...
    /*
     * Return the date exits on the video or not
     */
    ...
    /*
     * returns the date available in the video
     */

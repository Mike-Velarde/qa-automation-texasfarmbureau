...
public class TestDataManager {
    ...
    protected User qaUser = new User("User", "Password");
    protected User prodUser = new User("User", "Password");

    public final static String NORMAL_ENV = "normal";
    public final static String CLIENT_ENV = "client";
    ...
    final static String QA = "qa";
    final static String STAGING = "staging";
    final static String PROD = "prod";
    ...
    public void setUser(String env, String locale) {
        if(env.equals(PROD)) {
            ...
            activeUser = new User("Here's another way to set a user!", "and a password");
        }
